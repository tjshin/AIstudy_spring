...
<div class="container">
  ...
  <form class="form-horizontal" method="post" action="./calc3">
    ...
    <div class="form-group">
    <label class="control-labsl col-sm-10" style="color:purple;">${menu}</label>
    </div>
    ...
    <div class="form-group">
    <label class="control-labsl col-sm-10" style="color:purple;">${price}</label>
    </div>
    ...
    <div class="form-group">
    <label class="control-labsl col-sm-10" style="color:purple;">${count}</label>
    </div>
